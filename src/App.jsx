  ...
  return (
    ...
    >
      ...
      <div className="w-16 bg-gray-900 flex flex-col items-center py-3 gap-2">
        <div className="w-10 h-10 bg-indigo-500 rounded-2xl flex items-center justify-center font-bold cursor-pointer hover:rounded-xl transition-all">D</div>
        <div className="w-8 border-t border-gray-600 my-1"></div>
        <div className="w-10 h-10 bg-gray-700 hover:bg-indigo-500 rounded-full hover:rounded-xl transition-all flex items-center justify-center cursor-pointer text-green-400 font-bold text-lg">+</div>
      </div>
                ...
                {!editingName ? (
                  <>
                    ...
                    <div className="border-t border-gray-700 mt-2 pt-2 flex flex-col gap-0.5">
                      ...
                      <button
                        ...
                        className="w-full text-left px-2 py-1.5 rounded hover:bg-gray-700 text-red-400 text-xs flex items-center gap-2"
                      >
                        ↪ Sign Out
                      </button>
                    </div>
                  ...
                  <>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-900 text-white rounded px-2 py-1.5 outline-none focus:ring-2 focus:ring-indigo-500 mb-3 text-xs"
                    />
          ...
          <div className="p-2 bg-gray-900 flex items-center gap-2">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className={`w-7 h-7 rounded flex items-center justify-center hover:bg-gray-700 ${muted ? 'text-red-400' : 'text-gray-400 hover:text-white'}`}
              >
                {muted ? '🔇' : '🎤'}
              </button>
              <button
                ...
                className={`w-7 h-7 rounded flex items-center justify-center hover:bg-gray-700 ${deafened ? 'text-red-400' : 'text-gray-400 hover:text-white'}`}
              >
                {deafened ? '🔕' : '🎧'}
              </button>
              <button
                title="Settings"
                className="w-7 h-7 rounded flex items-center justify-center hover:bg-gray-700 text-gray-400 hover:text-white"
              >
                ⚙️
              </button>
            </div>
